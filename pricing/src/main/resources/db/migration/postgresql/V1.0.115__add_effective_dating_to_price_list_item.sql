-- Pricing Module Extension: Effective-dated price items (PostgreSQL)
...
ALTER TABLE price_list_item ADD COLUMN effective_from TIMESTAMPTZ;
ALTER TABLE price_list_item ADD COLUMN effective_to TIMESTAMPTZ;
