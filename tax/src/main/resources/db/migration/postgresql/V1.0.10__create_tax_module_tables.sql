-- Tax Module Database Migration Script (PostgreSQL)
-- Version: 3.1
...
CREATE INDEX idx_business_type_code ON business_types (business_type);
CREATE INDEX idx_business_type_active ON business_types (is_active);
CREATE INDEX idx_business_type_uid ON business_types (uid);
...
CREATE INDEX idx_hsn_code ON hsn_codes (hsn_code);
CREATE INDEX idx_hsn_chapter ON hsn_codes (hsn_chapter);
CREATE INDEX idx_hsn_heading ON hsn_codes (hsn_heading);
CREATE INDEX idx_hsn_parent ON hsn_codes (parent_hsn_id);
CREATE INDEX idx_hsn_active ON hsn_codes (is_active);
CREATE INDEX idx_hsn_level ON hsn_codes (level);
CREATE INDEX idx_hsn_uid ON hsn_codes (uid);
...
CREATE INDEX idx_tax_rate_hsn ON tax_rates (hsn_code_id);
CREATE INDEX idx_tax_rate_component ON tax_rates (tax_component_type);
CREATE INDEX idx_tax_rate_business ON tax_rates (business_type);
CREATE INDEX idx_tax_rate_zone ON tax_rates (geographical_zone);
CREATE INDEX idx_tax_rate_effective ON tax_rates (effective_from, effective_to);
CREATE INDEX idx_tax_rate_active ON tax_rates (is_active);
CREATE INDEX idx_tax_rate_lookup ON tax_rates (hsn_code_id, business_type, effective_from, is_active);
CREATE INDEX idx_tax_rate_uid ON tax_rates (uid);
CREATE UNIQUE INDEX uk_tax_rates ON tax_rates (hsn_code_id, tax_component_type, business_type, geographical_zone, effective_from);
...
CREATE INDEX idx_tax_config_business ON tax_configurations (business_type_id);
CREATE INDEX idx_tax_config_hsn ON tax_configurations (hsn_code_id);
CREATE INDEX idx_tax_config_zone ON tax_configurations (geographical_zone);
...
CREATE INDEX idx_tax_config_lookup ON tax_configurations (business_type_id, hsn_code_id, effective_from, is_active);
CREATE INDEX idx_tax_config_uid ON tax_configurations (uid);
CREATE UNIQUE INDEX uk_tax_configurations ON tax_configurations (business_type_id, hsn_code_id, geographical_zone, effective_from);
