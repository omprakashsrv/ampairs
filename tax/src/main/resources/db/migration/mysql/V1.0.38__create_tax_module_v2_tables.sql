...
('MTC_IN_HSN_8517', 'IN', 'HSN_CODE', '8517', 'Telephone sets, including smartphones and other apparatus for transmission or reception of voice, images or other data', 'Smartphones', '85', '8517', 'ELECTRONICS', 18.0, 'GST_18', TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
('MTC_IN_HSN_3004', 'IN', 'HSN_CODE', '3004', 'Medicaments (excluding goods of heading 30.02, 30.05 or 30.06) consisting of mixed or unmixed products for therapeutic or prophylactic uses', 'Medicines', '30', '3004', 'PHARMACEUTICAL', 12.0, 'GST_12', TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
('MTC_IN_HSN_6109', 'IN', 'HSN_CODE', '6109', 'T-shirts, singlets and other vests, knitted or crocheted', 'T-shirts', '61', '6109', 'TEXTILES', 12.0, 'GST_12', TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
('MTC_IN_HSN_8471', 'IN', 'HSN_CODE', '8471', 'Automatic data processing machines and units thereof; magnetic or optical readers', 'Computers', '84', '8471', 'ELECTRONICS', 18.0, 'GST_18', TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
('MTC_IN_HSN_2710', 'IN', 'HSN_CODE', '2710', 'Petroleum oils and oils obtained from bituminous minerals, other than crude', 'Petroleum products', '27', '2710', 'ENERGY', 28.0, 'GST_28', TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
('MTC_IN_HSN_9403', 'IN', 'HSN_CODE', '9403', 'Other furniture and parts thereof', 'Furniture', '94', '9403', 'FURNITURE', 18.0, 'GST_18', TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
('MTC_IN_SAC_998314', 'IN', 'SAC_CODE', '998314', 'Consulting engineer''s services', 'Engineering services', NULL, NULL, 'SERVICES', 18.0, 'GST_18', TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
('MTC_IN_SAC_996511', 'IN', 'SAC_CODE', '996511', 'Information technology design and development services', 'IT development', NULL, NULL, 'SERVICES', 18.0, 'GST_18', TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
