...
dependencies {
    flywayRuntime("org.flywaydb:flyway-core:13.0.0")
    flywayRuntime("org.flywaydb:flyway-database-postgresql:13.0.0")
    flywayRuntime("org.flywaydb:flyway-mysql:13.0.0")
