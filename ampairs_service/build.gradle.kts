...
dependencies {
    flywayRuntime("org.flywaydb:flyway-core:12.10.0")
    flywayRuntime("org.flywaydb:flyway-database-postgresql:12.10.0")
    flywayRuntime("org.flywaydb:flyway-mysql:12.10.0")
