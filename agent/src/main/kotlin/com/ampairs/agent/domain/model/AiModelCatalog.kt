...
object AiModelCatalog {
    ...
    val MODELS: List<AiModelDescriptor> = listOf(
        AiModelDescriptor(
            ...
            recommended = true,
            sourceUrl = "$HF/litert-community/gemma-3-270m-it/resolve/main/gemma-3-270m-it-int8.litertlm",
        ),
        AiModelDescriptor(
            id = "gemma3-1b-it",
            name = "Gemma 3 1B",
        ...
        AiModelDescriptor(
            ...
            platforms = setOf(ModelPlatform.ANDROID, ModelPlatform.IOS, ModelPlatform.DESKTOP),
            recommended = true,
            sourceUrl = "$HF/litert-community/gemma-4-E2B-it-litert-lm/resolve/main/gemma-4-E2B-it-int4.litertlm",
        ),
        AiModelDescriptor(
            id = "gemma-4-E4B-it",
            name = "Gemma 4 E4B",
            ...
            platforms = setOf(ModelPlatform.ANDROID, ModelPlatform.IOS, ModelPlatform.DESKTOP),
            recommended = false,
            sourceUrl = "$HF/litert-community/gemma-4-E4B-it-litert-lm/resolve/main/gemma-4-E4B-it-int4.litertlm",
        ),
        AiModelDescriptor(
            id = "gemma-4-12B-it",
            name = "Gemma 4 12B",
            family = "gemma4",
            parameterLabel = "12B",
            fileName = "gemma-4-12B-it-int4.litertlm",
            sizeBytes = 8_000_000_000L,
            sha256 = null,
            requiredRamMb = 16384,
            backendId = "litert-lm",
            platforms = setOf(ModelPlatform.DESKTOP),
            recommended = false,
            sourceUrl = "$HF/litert-community/gemma-4-12B-it-litert-lm/resolve/main/gemma-4-12B-it-int4.litertlm",
        ),
    )
