...
**STRATEGY: Implement module-by-module for easier manual testing**

### Phase 3.5.1: Product Management Module (Web)
...
- [ ] T079a Create product routing in ampairs-web/src/app/retail/product/product-routing.module.ts
- [ ] T080a Update main navigation to include product module in ampairs-web/src/app/layout/

### Phase 3.5.2: Customer Management Module (Web)
...
- [ ] T079b Create customer routing in ampairs-web/src/app/retail/customer/customer-routing.module.ts
- [ ] T080b Update main navigation to include customer module in ampairs-web/src/app/layout/

### Phase 3.5.3: Order Management Module (Web)
...
- [ ] T079c Create order routing in ampairs-web/src/app/retail/order/order-routing.module.ts
- [ ] T080c Update main navigation to include order module in ampairs-web/src/app/layout/

### Phase 3.5.4: Invoice Management Module (Web)
...
- [ ] T079d Create invoice routing in ampairs-web/src/app/retail/invoice/invoice-routing.module.ts
- [ ] T080d Update main navigation to include invoice module in ampairs-web/src/app/layout/

### Phase 3.5.5: Tax Management Module (Web)
...
- [ ] T079e Create tax routing in ampairs-web/src/app/retail/tax/tax-routing.module.ts
- [ ] T080e Update main navigation to include tax module in ampairs-web/src/app/layout/

### Phase 3.5.6: Integration & Dashboard (Web)
- [ ] T079 Create main retail routing module in ampairs-web/src/app/retail/retail-routing.module.ts
...
### Phase 3.6.1: Product Management Module (Mobile)
...
- [ ] T123a Create product navigation in ampairs-mp-app/composeApp/src/commonMain/kotlin/com/ampairs/retail/product/Navigation.kt
- [ ] T125a [P] Create Android-specific product components in ampairs-mp-app/composeApp/src/androidMain/kotlin/com/ampairs/retail/product/

### Phase 3.6.2: Customer Management Module (Mobile)
...
- [ ] T123b Create customer navigation in ampairs-mp-app/composeApp/src/commonMain/kotlin/com/ampairs/retail/customer/Navigation.kt
- [ ] T125b [P] Create Android-specific customer components in ampairs-mp-app/composeApp/src/androidMain/kotlin/com/ampairs/retail/customer/

### Phase 3.6.3: Order Management Module (Mobile)
...
- [ ] T123c Create order navigation in ampairs-mp-app/composeApp/src/commonMain/kotlin/com/ampairs/retail/order/Navigation.kt
- [ ] T125c [P] Create Android-specific order components in ampairs-mp-app/composeApp/src/androidMain/kotlin/com/ampairs/retail/order/

### Phase 3.6.4: Invoice Management Module (Mobile)
...
- [ ] T123d Create invoice navigation in ampairs-mp-app/composeApp/src/commonMain/kotlin/com/ampairs/retail/invoice/Navigation.kt
- [ ] T125d [P] Create Android-specific invoice components in ampairs-mp-app/composeApp/src/androidMain/kotlin/com/ampairs/retail/invoice/

### Phase 3.6.5: Tax Management Module (Mobile)
...
- [ ] T123e Create tax navigation in ampairs-mp-app/composeApp/src/commonMain/kotlin/com/ampairs/retail/tax/Navigation.kt
- [ ] T125e [P] Create Android-specific tax components in ampairs-mp-app/composeApp/src/androidMain/kotlin/com/ampairs/retail/tax/

### Phase 3.6.6: Integration & Platform Support (Mobile)
- [ ] T123 Create main retail navigation graph in ampairs-mp-app/composeApp/src/commonMain/kotlin/com/ampairs/retail/Navigation.kt
