...
**Performance Goals**: Incremental sync — a no-change cycle processes 0 records (SC-003); batched pull/push at 100 records/page consistent with the existing `/sync` contract; connector catalogue/install/config endpoints are standard CRUD (<200ms p95).
