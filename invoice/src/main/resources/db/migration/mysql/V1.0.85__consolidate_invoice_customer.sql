...
ALTER TABLE invoice ADD COLUMN customer_id VARCHAR(36) NULL;
ALTER TABLE invoice ADD COLUMN customer_name VARCHAR(255) NULL;
ALTER TABLE invoice ADD COLUMN customer_phone VARCHAR(20) NULL;
...
DROP INDEX idx_invoice_to_customer ON invoice;
