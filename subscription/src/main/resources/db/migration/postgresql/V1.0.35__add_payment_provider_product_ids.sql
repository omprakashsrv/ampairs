...
COMMENT ON COLUMN subscription_plans.google_play_product_id_monthly IS 'Google Play product ID for monthly billing';
COMMENT ON COLUMN subscription_plans.google_play_product_id_annual IS 'Google Play product ID for annual billing';
...
COMMENT ON COLUMN subscription_plans.app_store_product_id_monthly IS 'App Store product ID for monthly billing';
COMMENT ON COLUMN subscription_plans.app_store_product_id_annual IS 'App Store product ID for annual billing';
...
COMMENT ON COLUMN subscription_plans.razorpay_plan_id_monthly IS 'Razorpay plan ID for monthly billing';
COMMENT ON COLUMN subscription_plans.razorpay_plan_id_annual IS 'Razorpay plan ID for annual billing';
