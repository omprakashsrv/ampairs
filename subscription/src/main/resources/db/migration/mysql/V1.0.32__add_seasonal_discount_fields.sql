...
ALTER TABLE subscription_plans
    ADD COLUMN seasonal_discount_percent INT NOT NULL DEFAULT 0 COMMENT 'Seasonal discount percentage (0-100)',
    ADD COLUMN seasonal_discount_name VARCHAR(100) COMMENT 'Discount name (e.g., Diwali Sale, New Year Offer)',
    ADD COLUMN seasonal_discount_start_at TIMESTAMP NULL COMMENT 'Discount start date (UTC)',
    ADD COLUMN seasonal_discount_end_at TIMESTAMP NULL COMMENT 'Discount end date (UTC)';
