...
ALTER TABLE subscription_plans
    ADD COLUMN multi_workspace_min_count INT NOT NULL DEFAULT 0 COMMENT 'Minimum workspaces required for discount',
    ADD COLUMN multi_workspace_discount_percent INT NOT NULL DEFAULT 0 COMMENT 'Discount percentage (0-100) for multiple workspaces';
