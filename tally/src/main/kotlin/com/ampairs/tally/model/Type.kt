...
enum class Type(var type: String, var id: String) {
    UNIT("UNIT", "CUSTOMUNITCOL"), LEDGER("LEDGER", "CUSTOMLEDGERCOL"), STOCK_ITEM("STOCKITEM", "CUSTOMLEDGERCOL"),
    STOCK_GROUP("UNIT", "CUSTOMLEDGERCOL"), STOCK_CATEGORY("UNIT", "CUSTOMLEDGERCOL"),
