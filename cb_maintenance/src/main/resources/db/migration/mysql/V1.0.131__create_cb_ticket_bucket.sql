...
CREATE TABLE ticket_bucket (
    ...
    PRIMARY KEY (id),
    UNIQUE INDEX idx_cb_ticket_bucket_uid (uid),
    INDEX idx_cb_ticket_bucket_owner (owner_id),
    INDEX idx_cb_ticket_bucket_dept (department),
    UNIQUE INDEX uk_cb_ticket_bucket (owner_id, department, category, sub_category_1, sub_category_2)
