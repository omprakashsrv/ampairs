...
class WorkspaceMemberApiImpl(
    ...
    override suspend fun getWorkspaceMembers(
        ...
        return get(client, "$WORKSPACE_ENDPOINT/workspace/v1/member", params)
    }
    ...
    override suspend fun getMemberDetails(
        ...
        return get(client, "$WORKSPACE_ENDPOINT/workspace/v1/member/$memberId")
    }
    ...
    override suspend fun updateMember(
        ...
        return put(client, "$WORKSPACE_ENDPOINT/workspace/v1/member/$memberId", request)
    }
