-- Retire inventory_config (spec 014, T011) — PostgreSQL
...
SELECT 'inv_cfg_' || ic.owner_id || '_auto_deduct_on_order', ic.owner_id, 'inventory', 'auto_deduct_on_order',
       CASE WHEN ic.auto_deduct_on_order THEN 'true' ELSE 'false' END, 'BOOLEAN', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
INSERT INTO store_setting (uid, owner_id, module_code, setting_key, value, value_type, active, created_at, updated_at)
SELECT 'inv_cfg_' || ic.owner_id || '_block_orders_when_out_of_stock', ic.owner_id, 'inventory', 'block_orders_when_out_of_stock',
       CASE WHEN ic.block_orders_when_out_of_stock THEN 'true' ELSE 'false' END, 'BOOLEAN', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM inventory_config ic
...
INSERT INTO store_setting (uid, owner_id, module_code, setting_key, value, value_type, active, created_at, updated_at)
SELECT 'inv_cfg_' || ic.owner_id || '_allow_negative_stock', ic.owner_id, 'inventory', 'allow_negative_stock',
       CASE WHEN ic.allow_negative_stock THEN 'true' ELSE 'false' END, 'BOOLEAN', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM inventory_config ic
...
INSERT INTO store_setting (uid, owner_id, module_code, setting_key, value, value_type, active, created_at, updated_at)
SELECT 'inv_cfg_' || ic.owner_id || '_allow_manual_override', ic.owner_id, 'inventory', 'allow_manual_override',
       CASE WHEN ic.allow_manual_override THEN 'true' ELSE 'false' END, 'BOOLEAN', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM inventory_config ic
...
INSERT INTO store_setting (uid, owner_id, module_code, setting_key, value, value_type, active, created_at, updated_at)
SELECT 'inv_cfg_' || ic.owner_id || '_enable_low_stock_alerts', ic.owner_id, 'inventory', 'enable_low_stock_alerts',
       CASE WHEN ic.enable_low_stock_alerts THEN 'true' ELSE 'false' END, 'BOOLEAN', TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM inventory_config ic
