...
/**
 * Jackson configuration for timezone handling and Kotlin support.
 *
 ...
 * 5. Register KotlinModule for Kotlin data class support (default parameters, nullability)
 *
 * This ensures all API responses have consistent, unambiguous timestamps in UTC format
 * and proper Kotlin deserialization support.
 *
...
class JacksonConfig {
    ...
    /**
     * Customize Jackson ObjectMapper for UTC timezone handling and Kotlin support.
     *
     * This customizer:
     ...
     * - Registers KotlinModule to support Kotlin data classes with default parameters
    ...
    fun jackson2ObjectMapperBuilderCustomizer(): Jackson2ObjectMapperBuilderCustomizer {
        return Jackson2ObjectMapperBuilderCustomizer { builder ->
            builder
                ...
                // Register modules
                .modules(
                    JavaTimeModule(),                    // Support java.time.* types (Instant, LocalDateTime, etc.)
                    KotlinModule.Builder().build()       // Support Kotlin data classes, default parameters, nullability
                )
