package com.ampairs.file.config
 ...
 * Relocated from the core module to centralize file and object storage configuration.
 */
...
data class AmpairsAwsProperties(
    ...
    data class SnsConfig(
        ...
        val smsType: String = "Transactional",
    )
}
