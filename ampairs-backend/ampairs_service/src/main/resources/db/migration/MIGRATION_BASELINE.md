...
- Migrations `V3_1` and `V3_2` (tax/event modules) are already tracked.
- The new retail baseline comprises `V4_1` through `V4_7`, covering core, unit, customer, product, inventory, order, invoice, and form modules.
