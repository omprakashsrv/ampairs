...
- Retail migrations `V4_1` through `V4_10` live in their respective modules under `src/main/resources/db/migration/mysql/` and are loaded via the service classpath.
